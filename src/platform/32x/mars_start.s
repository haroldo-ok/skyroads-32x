...
! Rom header and SH2 init/exception code - must be first in object list
	...
	.endr
		...
		.ascii	"SEGA 32X        "
		.ascii	"SKYROADS 32X    "
		.ascii	"SKYROADS 32X PORT                               "
		.ascii	"SKYROADS 32X PORT                               "
		.ascii	"GM SKYROADS-00  "
		.ascii	"J6              "
		.long	0x000000
		.long	0x3FFFFF
		.long	0xFF0000
...
MARS_HEADER:
		.ascii	"SKYROADS 32X    "	/* module name (16 chars) */
...
! let Slave SH2 run. Reload COMM0: __INIT_SECTION__ is allowed to clobber r0,
! so using the stale value here leaves COMM4 at S_OK and deadlocks the slave.
		mov.l   _master_sts,r0
		mov     #0,r1
